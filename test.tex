...
\def\achars{N(a),[],;,H,L,Z,X,M,U,D,D{A},T,tt,C,cc,}
\def\bchars{H,L,Z,X,M,U,D,D{B},T,tt,C,cc,}
\def\cchars{H,L,Z,X,M,U,D,D{C},T,tt,C,cc,}
...
\foreach \a in \achars {%
    ...
    \foreach \b in \bchars {%
      ...
      \foreach \c in \cchars {%
        ...
        {\noexpand\texttiming[\I]{\b\a\c}};}%
        \temp
      }%
    }%
     \draw [help lines] (-2.5,2) rectangle ($ (x) + (3,-1) $);
        \message{ ^^J^^J }%
    \end{tikzpicture}%
    \end{preview}
    \newpage
